...
import vialWasherImage from "@/assets/equipment/vial-washer.jpg";
import depyrogenationOvenImage from "@/assets/equipment/depyrogenation-oven.jpg";
import fillingLineImage from "@/assets/equipment/filling-line.jpg";
import lyophilizerImage from "@/assets/equipment/lyophilizer.jpg";
import cappingLabelingImage from "@/assets/equipment/capping-labeling.jpg";
import hplcImage from "@/assets/equipment/hplc.jpg";
import capillaryElectrophoresisImage from "@/assets/equipment/capillary-electrophoresis.jpg";
import microplateReaderImage from "@/assets/equipment/microplate-reader.jpg";
import uvVisImage from "@/assets/equipment/uv-vis.jpg";
...
export const EQUIPMENT: Equipment[] = [
  ...
  // ── Downstream ──
  {
    ...
    imageUrl: centrifugeImage,
    equipmentCategory: "downstream",
    integrationMode: "online",
    status: "idle",
    connectionHealth: "connected",
    currentBatch: null,
    lastBatch: "B-25-456-030",
    processPhase: "Idle",
    lastOperationAt: "2026-04-23T08:30:00",
    lastDataReceivedAt: "2026-04-23T08:35:00",
  ...
  },
  {
    ...
    lastBatch: "B-25-456-030",
    processPhase: "Idle",
    lastOperationAt: "2026-04-23T09:40:00",
    lastDataReceivedAt: "2026-04-23T09:45:00",
  ...
  },
  {
    ...
    connectionHealth: "connected",
    currentBatch: null,
    lastBatch: "B-25-456-029",
    processPhase: "Idle",
    lastOperationAt: "2026-04-22T22:50:00",
    lastDataReceivedAt: "2026-04-22T22:55:00",
    methodName: "UF/DF – 30 kDa cassette",
    alertCount: 0,
    criticalAlert: false,
  ...
  },
  {
    ...
    imageUrl: depyrogenationOvenImage,
    equipmentCategory: "downstream",
    integrationMode: "online",
    status: "active",
    connectionHealth: "connected",
  ...
  },
  {
    ...
    lastBatch: "B-25-456-029",
    processPhase: "Idle",
    lastOperationAt: "2026-04-22T23:20:00",
    lastDataReceivedAt: "2026-04-22T23:58:00",
  ...
  },
  {
    ...
    lastBatch: "B-25-456-029",
    processPhase: "Idle",
    lastOperationAt: "2026-04-22T23:25:00",
    lastDataReceivedAt: "2026-04-22T23:55:00",
  ...
  },
  {
    ...
    currentBatch: "B-25-456-029",
    processPhase: "Result uploaded",
    lastOperationAt: "2026-04-23T18:10:00",
    lastDataReceivedAt: "2026-04-23T18:10:00",
  ...
  },
  {
    ...
    imageUrl: capillaryElectrophoresisImage,
    equipmentCategory: "analytical",
    integrationMode: "online",
    status: "idle",
    connectionHealth: "connected",
  ...
  },
  {
    ...
    imageUrl: microplateReaderImage,
    equipmentCategory: "analytical",
    integrationMode: "online",
    status: "active",
    connectionHealth: "connected",
  ...
  },
  {
    ...
    currentBatch: "B-25-456-030",
    processPhase: "Result uploaded",
    lastOperationAt: "2026-04-23T15:00:00",
    lastDataReceivedAt: "2026-04-23T15:05:00",
  ...
  },
  {
    ...
    imageUrl: cellAnalyzerImage,
    equipmentCategory: "analytical",
    integrationMode: "online",
    status: "active",
    connectionHealth: "connected",
    currentBatch: "B-25-456-032",
    processPhase: "Result uploaded",
    lastOperationAt: "2026-04-23T10:30:00",
